...
void makeCutFlowTable(bool NOTANPAS = false)
{
  ...
  TFile *ttbar = new TFile(inFile+"ttbar_ele_selection.root");
  ...
  h_ttbar->Scale(lumi); h_ttbar->Scale(1.0/h_ttbar_toppt->GetBinContent(2));
...
{ 
  ...
  TFile *wh = new TFile(inFile+"wh_M_120_selection_.root"); 
  ...
  TFile *ttbar = new TFile(inFile+"ttbar_selection_.root"); 
  ...
  TFile *wjet = new TFile(inFile+"wjet_selection_.root"); 
  ...
  TFile *zjet = new TFile(inFile+"zjet_selection_.root");
  ...
  TFile *qcd = new TFile(inFile+"qcd_selection_.root");
  ...
  TFile *stop = new TFile(inFile+"singletop_selection_.root");
  ...
  TFile *diboson = new TFile(inFile+"diboson_selection_.root");
  ...
  h_wh_base->Scale(lumi);h_wh_base->Scale(1.0/0.98637);
  h_wh_JESPlus->Scale(lumi);h_wh_JESPlus->Scale(1.0/0.98637);
  h_wh_JESMinus->Scale(lumi);h_wh_JESMinus->Scale(1.0/0.98637);
  h_wh_JERPlus->Scale(lumi); h_wh_JERPlus->Scale(1.0/0.98637);
  h_wh_JERMinus->Scale(lumi);h_wh_JERMinus->Scale(1.0/0.98637);
  h_wh_METUCPlus->Scale(lumi);h_wh_METUCPlus->Scale(1.0/0.98637);
  h_wh_METUCMinus->Scale(lumi);h_wh_METUCMinus->Scale(1.0/0.98637);
  h_wh_bTagPlus->Scale(lumi);h_wh_bTagPlus->Scale(1.0/0.98637);
  h_wh_bTagMinus->Scale(lumi);h_wh_bTagMinus->Scale(1.0/0.98637);

  h_ttbar_base->Scale(lumi);h_ttbar_base->Scale(1.0/0.989606);
  h_ttbar_JESPlus->Scale(lumi);h_ttbar_JESPlus->Scale(1.0/0.989606);
  h_ttbar_JESMinus->Scale(lumi);h_ttbar_JESMinus->Scale(1.0/0.989606);
  h_ttbar_JERPlus->Scale(lumi);h_ttbar_JERPlus->Scale(1.0/0.989606);
  h_ttbar_JERMinus->Scale(lumi);h_ttbar_JERMinus->Scale(1.0/0.989606);
  h_ttbar_METUCPlus->Scale(lumi);h_ttbar_METUCPlus->Scale(1.0/0.989606);
  h_ttbar_METUCMinus->Scale(lumi); h_ttbar_METUCMinus->Scale(1.0/0.989606);
  h_ttbar_bTagPlus->Scale(lumi);h_ttbar_bTagPlus->Scale(1.0/0.989606);
  h_ttbar_bTagMinus->Scale(lumi);h_ttbar_bTagMinus->Scale(1.0/0.989606);

  h_wjet_base->Scale(lumi);
  h_wjet_JESPlus->Scale(lumi);
  h_wjet_JESMinus->Scale(lumi);
  h_wjet_JERPlus->Scale(lumi);
  h_wjet_JERMinus->Scale(lumi);
  h_wjet_METUCPlus->Scale(lumi);
  h_wjet_METUCMinus->Scale(lumi);
  h_wjet_bTagPlus->Scale(lumi);
  h_wjet_bTagMinus->Scale(lumi);

  h_zjet_base->Scale(lumi);
  h_zjet_JESPlus->Scale(lumi);
  h_zjet_JESMinus->Scale(lumi);
  h_zjet_JERPlus->Scale(lumi);
  h_zjet_JERMinus->Scale(lumi);
  h_zjet_METUCPlus->Scale(lumi);
  h_zjet_METUCMinus->Scale(lumi);
  h_zjet_bTagPlus->Scale(lumi);
  h_zjet_bTagMinus->Scale(lumi);

  h_qcd_base->Scale(lumi);
  h_qcd_JESPlus->Scale(lumi);
  h_qcd_JESMinus->Scale(lumi);
  h_qcd_JERPlus->Scale(lumi);
  h_qcd_JERMinus->Scale(lumi);
  h_qcd_METUCPlus->Scale(lumi);
  h_qcd_METUCMinus->Scale(lumi);
  h_qcd_bTagPlus->Scale(lumi);
  h_qcd_bTagMinus->Scale(lumi);

  h_stop_base->Scale(lumi);
  h_stop_JESPlus->Scale(lumi);
  h_stop_JESMinus->Scale(lumi);
  h_stop_JERPlus->Scale(lumi);
  h_stop_JERMinus->Scale(lumi);
  h_stop_METUCPlus->Scale(lumi);
  h_stop_METUCMinus->Scale(lumi);
  h_stop_bTagPlus->Scale(lumi);
  h_stop_bTagMinus->Scale(lumi);

  h_diboson_base->Scale(lumi);
  h_diboson_JESPlus->Scale(lumi);
  h_diboson_JESMinus->Scale(lumi);
  h_diboson_JERPlus->Scale(lumi);
  h_diboson_JERMinus->Scale(lumi);
  h_diboson_METUCPlus->Scale(lumi);
  h_diboson_METUCMinus->Scale(lumi);
  h_diboson_bTagPlus->Scale(lumi);
  h_diboson_bTagMinus->Scale(lumi);
...
{  
  ...
  h1_wh_base->Scale(lumi);h1_wh_base->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_JESPlus->Scale(lumi);h1_wh_JESPlus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_JESMinus->Scale(lumi);h1_wh_JESMinus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_JERPlus->Scale(lumi); h1_wh_JERPlus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_JERMinus->Scale(lumi);h1_wh_JERMinus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_METUCPlus->Scale(lumi);h1_wh_METUCPlus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_METUCMinus->Scale(lumi);h1_wh_METUCMinus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_bTagPlus->Scale(lumi);h1_wh_bTagPlus->Scale(1.0/h1_wh_toppt->GetBinContent(2));
  h1_wh_bTagMinus->Scale(lumi);h1_wh_bTagMinus->Scale(1.0/h1_wh_toppt->GetBinContent(2));

  h2_wh_base->Scale(lumi);h2_wh_base->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_JESPlus->Scale(lumi);h2_wh_JESPlus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_JESMinus->Scale(lumi);h2_wh_JESMinus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_JERPlus->Scale(lumi); h2_wh_JERPlus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_JERMinus->Scale(lumi);h2_wh_JERMinus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_METUCPlus->Scale(lumi);h2_wh_METUCPlus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_METUCMinus->Scale(lumi);h2_wh_METUCMinus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_bTagPlus->Scale(lumi);h2_wh_bTagPlus->Scale(1.0/h2_wh_toppt->GetBinContent(2));
  h2_wh_bTagMinus->Scale(lumi);h2_wh_bTagMinus->Scale(1.0/h2_wh_toppt->GetBinContent(2));

  h1_ttbar_base->Scale(lumi);h1_ttbar_base->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_JESPlus->Scale(lumi);h1_ttbar_JESPlus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_JESMinus->Scale(lumi);h1_ttbar_JESMinus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_JERPlus->Scale(lumi);h1_ttbar_JERPlus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_JERMinus->Scale(lumi);h1_ttbar_JERMinus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_METUCPlus->Scale(lumi);h1_ttbar_METUCPlus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_METUCMinus->Scale(lumi); h1_ttbar_METUCMinus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_bTagPlus->Scale(lumi);h1_ttbar_bTagPlus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  h1_ttbar_bTagMinus->Scale(lumi);h1_ttbar_bTagMinus->Scale(1.0/h1_ttbar_toppt->GetBinContent(2));
  
  h2_ttbar_base->Scale(lumi);h2_ttbar_base->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_JESPlus->Scale(lumi);h2_ttbar_JESPlus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_JESMinus->Scale(lumi);h2_ttbar_JESMinus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_JERPlus->Scale(lumi);h2_ttbar_JERPlus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_JERMinus->Scale(lumi);h2_ttbar_JERMinus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_METUCPlus->Scale(lumi);h2_ttbar_METUCPlus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_METUCMinus->Scale(lumi); h2_ttbar_METUCMinus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_bTagPlus->Scale(lumi);h2_ttbar_bTagPlus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));
  h2_ttbar_bTagMinus->Scale(lumi);h2_ttbar_bTagMinus->Scale(1.0/h2_ttbar_toppt->GetBinContent(2));

  // scale to luminosity
  h1_wjet_base->Scale(lumi);
  h1_wjet_JESPlus->Scale(lumi);
  h1_wjet_JESMinus->Scale(lumi);
  h1_wjet_JERPlus->Scale(lumi);
  h1_wjet_JERMinus->Scale(lumi);
  h1_wjet_METUCPlus->Scale(lumi);
  h1_wjet_METUCMinus->Scale(lumi);
  h1_wjet_bTagPlus->Scale(lumi);
  h1_wjet_bTagMinus->Scale(lumi);

  h2_wjet_base->Scale(lumi);
  h2_wjet_JESPlus->Scale(lumi);
  h2_wjet_JESMinus->Scale(lumi);
  h2_wjet_JERPlus->Scale(lumi);
  h2_wjet_JERMinus->Scale(lumi);
  h2_wjet_METUCPlus->Scale(lumi);
  h2_wjet_METUCMinus->Scale(lumi);
  h2_wjet_bTagPlus->Scale(lumi);
  h2_wjet_bTagMinus->Scale(lumi);
  
  h1_zjet_base->Scale(lumi);
  h1_zjet_JESPlus->Scale(lumi);
  h1_zjet_JESMinus->Scale(lumi);
  h1_zjet_JERPlus->Scale(lumi);
  h1_zjet_JERMinus->Scale(lumi);
  h1_zjet_METUCPlus->Scale(lumi);
  h1_zjet_METUCMinus->Scale(lumi);
  h1_zjet_bTagPlus->Scale(lumi);
  h1_zjet_bTagMinus->Scale(lumi);

  h2_zjet_base->Scale(lumi);
  h2_zjet_JESPlus->Scale(lumi);
  h2_zjet_JESMinus->Scale(lumi);
  h2_zjet_JERPlus->Scale(lumi);
  h2_zjet_JERMinus->Scale(lumi);
  h2_zjet_METUCPlus->Scale(lumi);
  h2_zjet_METUCMinus->Scale(lumi);
  h2_zjet_bTagPlus->Scale(lumi);
  h2_zjet_bTagMinus->Scale(lumi);
  
  h1_qcd_base->Scale(lumi);
  h1_qcd_JESPlus->Scale(lumi);
  h1_qcd_JESMinus->Scale(lumi);
  h1_qcd_JERPlus->Scale(lumi);
  h1_qcd_JERMinus->Scale(lumi);
  h1_qcd_METUCPlus->Scale(lumi);
  h1_qcd_METUCMinus->Scale(lumi);
  h1_qcd_bTagPlus->Scale(lumi);
  h1_qcd_bTagMinus->Scale(lumi);

  h2_qcd_base->Scale(lumi);
  h2_qcd_JESPlus->Scale(lumi);
  h2_qcd_JESMinus->Scale(lumi);
  h2_qcd_JERPlus->Scale(lumi);
  h2_qcd_JERMinus->Scale(lumi);
  h2_qcd_METUCPlus->Scale(lumi);
  h2_qcd_METUCMinus->Scale(lumi);
  h2_qcd_bTagPlus->Scale(lumi);
  h2_qcd_bTagMinus->Scale(lumi);

  h1_stop_base->Scale(lumi);
  h1_stop_JESPlus->Scale(lumi);
  h1_stop_JESMinus->Scale(lumi);
  h1_stop_JERPlus->Scale(lumi);
  h1_stop_JERMinus->Scale(lumi);
  h1_stop_METUCPlus->Scale(lumi);
  h1_stop_METUCMinus->Scale(lumi);
  h1_stop_bTagPlus->Scale(lumi);
  h1_stop_bTagMinus->Scale(lumi);

  h2_stop_base->Scale(lumi);
  h2_stop_JESPlus->Scale(lumi);
  h2_stop_JESMinus->Scale(lumi);
  h2_stop_JERPlus->Scale(lumi);
  h2_stop_JERMinus->Scale(lumi);
  h2_stop_METUCPlus->Scale(lumi);
  h2_stop_METUCMinus->Scale(lumi);
  h2_stop_bTagPlus->Scale(lumi);
  h2_stop_bTagMinus->Scale(lumi);
  
  h1_diboson_base->Scale(lumi);
  h1_diboson_JESPlus->Scale(lumi);
  h1_diboson_JESMinus->Scale(lumi);
  h1_diboson_JERPlus->Scale(lumi);
  h1_diboson_JERMinus->Scale(lumi);
  h1_diboson_METUCPlus->Scale(lumi);
  h1_diboson_METUCMinus->Scale(lumi);
  h1_diboson_bTagPlus->Scale(lumi);
  h1_diboson_bTagMinus->Scale(lumi);

  h2_diboson_base->Scale(lumi);
  h2_diboson_JESPlus->Scale(lumi);
  h2_diboson_JESMinus->Scale(lumi);
  h2_diboson_JERPlus->Scale(lumi);
  h2_diboson_JERMinus->Scale(lumi);
  h2_diboson_METUCPlus->Scale(lumi);
  h2_diboson_METUCMinus->Scale(lumi);
  h2_diboson_bTagPlus->Scale(lumi);
  h2_diboson_bTagMinus->Scale(lumi);
...
{  
  ...
  h_plus_wh_base->Scale(lumi);
  h_plus_wh_JESPlus->Scale(lumi);
  h_plus_wh_JESMinus->Scale(lumi);
  h_minus_wh_base->Scale(lumi);
  h_minus_wh_JESPlus->Scale(lumi);
  h_minus_wh_JESMinus->Scale(lumi);


  h_plus_ttbar_base->Scale(lumi);
  h_plus_ttbar_JESPlus->Scale(lumi);
  h_plus_ttbar_JESMinus->Scale(lumi);
  h_minus_ttbar_base->Scale(lumi);
  h_minus_ttbar_JESPlus->Scale(lumi);
  h_minus_ttbar_JESMinus->Scale(lumi);


  h_plus_wjet_base->Scale(lumi);
  h_plus_wjet_JESPlus->Scale(lumi);
  h_plus_wjet_JESMinus->Scale(lumi);
  h_minus_wjet_base->Scale(lumi);
  h_minus_wjet_JESPlus->Scale(lumi);
  h_minus_wjet_JESMinus->Scale(lumi);


  h_plus_zjet_base->Scale(lumi);
  h_plus_zjet_JESPlus->Scale(lumi);
  h_plus_zjet_JESMinus->Scale(lumi);
  h_minus_zjet_base->Scale(lumi);
  h_minus_zjet_JESPlus->Scale(lumi);
  h_minus_zjet_JESMinus->Scale(lumi);

  h_plus_qcd_base->Scale(lumi);
  h_plus_qcd_JESPlus->Scale(lumi);
  h_plus_qcd_JESMinus->Scale(lumi);
  h_minus_qcd_base->Scale(lumi);
  h_minus_qcd_JESPlus->Scale(lumi);
  h_minus_qcd_JESMinus->Scale(lumi);

  h_plus_stop_base->Scale(lumi);
  h_plus_stop_JESPlus->Scale(lumi);
  h_plus_stop_JESMinus->Scale(lumi);
  h_minus_stop_base->Scale(lumi);
  h_minus_stop_JESPlus->Scale(lumi);
  h_minus_stop_JESMinus->Scale(lumi);

  h_plus_diboson_base->Scale(lumi);
  h_plus_diboson_JESPlus->Scale(lumi);
  h_plus_diboson_JESMinus->Scale(lumi);
  h_minus_diboson_base->Scale(lumi);
  h_minus_diboson_JESPlus->Scale(lumi);
  h_minus_diboson_JESMinus->Scale(lumi);
